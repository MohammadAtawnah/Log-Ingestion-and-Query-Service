...
async function runLoadTest() {
  ...
  console.log(`  Avg: ${ingestStats.avg.toFixed(1)}ms | p50: ${ingestStats.p50.toFixed(1)}ms | p95: ${ingestStats.p95.toFixed(1)}ms | p99: ${ingestStats.p99.toFixed(1)}ms | Max: ${ingestStats.max.toFixed(1)}ms`);
  console.log('-'.repeat(60));
  console.log('Concurrent Aggregation Latency (/logs/aggregate):');
  console.log(`  Avg: ${aggStats.avg.toFixed(1)}ms | p50: ${aggStats.p50.toFixed(1)}ms | p95: ${aggStats.p95.toFixed(1)}ms | p99: ${aggStats.p99.toFixed(1)}ms | Max: ${aggStats.max.toFixed(1)}ms`);
  console.log('-'.repeat(60));
  console.log('Concurrent Filter Query Latency (/logs):');
  console.log(`  Avg: ${queryStats.avg.toFixed(1)}ms | p50: ${queryStats.p50.toFixed(1)}ms | p95: ${queryStats.p95.toFixed(1)}ms | p99: ${queryStats.p99.toFixed(1)}ms | Max: ${queryStats.max.toFixed(1)}ms`);
  console.log('='.repeat(60));
